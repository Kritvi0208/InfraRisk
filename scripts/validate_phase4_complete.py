...
def validate_phase4():
    ...
    try:
        ...
        from src.core.contract_types import (
        ...
        from src.core.risk_rules import CATEGORY_WEIGHTS, RED_FLAG_KEYWORDS
        print("✅")
        ...
        from src.core.clause_resolver import ClauseResolver
        print("✅")
        
        print("   Importing custom_ner...", end=" ")
        from src.nlp.custom_ner import ContractNER
        print("✅")
        
        print("   Importing legal_bert_classifier...", end=" ")
        from src.nlp.legal_bert_classifier import LegalBertClassifier
        print("✅")
        
        print("   Importing contract_risk_scorer...", end=" ")
        from src.core.contract_risk_scorer import ContractRiskScorer
        print("✅")
        
        print("   Importing benchmark_database...", end=" ")
        from src.core.benchmark_database import BenchmarkDatabase
        print("✅")
        
        print("   Importing comparative_analysis...", end=" ")
        from src.core.comparative_analysis import ComparativeAnalyzer
        print("✅")
        
        print("   Importing phase4_pipeline...", end=" ")
        from src.core.phase4_pipeline import Phase4Pipeline
        print("✅")
