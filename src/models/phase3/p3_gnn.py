# Graph Neural Network for Portfolio Risk
import torch
...
class ProjectGNNNode(nn.Module):
    ...
    def forward(self, node_features, edge_list, edge_weights):
        ...
        for src, dst in edge_list:
            message = self.message_network(torch.cat([embeddings[src], embeddings[dst]], dim=-1))
...
class PortfolioGNN(nn.Module):
    ...
    def forward(self, projects, dependencies):
        ...
        return {'project_risks': project_risks, 'embeddings': embeddings}
