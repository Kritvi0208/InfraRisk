...
class ClassificationResult:
    ...
    def to_dict(self):
        return {
            ...
            'confidence': self.confidence,
            'top_k_predictions': [(cat.value, conf) for cat, conf in self.top_k_predictions],
...
class ContractAnalysisResult:
    ...
    risk_scores: ContractRiskScore = field(default_factory=lambda: ContractRiskScore(
    ...
    def to_dict(self):
        return {
            ...
            'classification_results': [c.to_dict() for c in self.classification_results],
