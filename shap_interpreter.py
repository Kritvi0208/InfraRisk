...
class SHAPInterpreter:
    ...
    def global_feature_importance(self, shap_values: Optional[np.ndarray] = None) -> Dict:
        """
            ...
            'feature_contributions': [
                {
                    ...
                    'value': float(self.X[sample_idx, i]) if self.X is not None else 0.0,
