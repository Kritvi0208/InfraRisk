...
from p5_game_state import GameState, Portfolio
...
class ScoringSystem:
    ...
    def calculate_score(
        ...
        breakdown.portfolio_management_score = self._score_portfolio_management(
            portfolio
        )
        ...
        breakdown.total_score = int(
            (
                ...
                + breakdown.portfolio_management_score
                * self.WEIGHTS["portfolio_management"]
            )
    ...
    def get_scoring_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "components": {
                ...
                "debt_optimization": {
                    "max": 250,
                    "weight": self.WEIGHTS["debt_optimization"],
                },
                "esg_integration": {
                    "max": 300,
                    "weight": self.WEIGHTS["esg_integration"],
                },
                "portfolio_management": {
                    "max": 200,
                    "weight": self.WEIGHTS["portfolio_management"],
                },
            },
