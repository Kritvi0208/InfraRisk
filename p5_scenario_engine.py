...
class ScenarioEngine:
    ...
    def create_scenario(
        self, scenario_type: ScenarioType, quarter: int, portfolio: Portfolio
    ) -> Optional[Scenario]:
    ...
    def _apply_severity(
        self, impacts: ScenarioImpact, severity: float
    ) -> ScenarioImpact:
        ...
        # Delay varies
        impacts_copy.construction_delay_months = int(
            impacts_copy.construction_delay_months * severity
        )
    ...
    def get_scenario_statistics(self) -> Dict[str, Any]:
        ...
        avg_severity = sum(s["severity"] for s in self.scenario_history) / len(
